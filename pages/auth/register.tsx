      ...
      <Box sx={{ backgroundImage: `url(/assets/images/section.jpg)` }}>
        ...
        >
          <Box className="flex justify-center items-center w-full min-h-[100vh] py-[40px] ">
            <form
              className="w-full max-w-xl px-9 py-10 bg-[#28282d] shadow-xl rounded border-t-2 border-primary"
              action="#"
            >
              <Stack spacing={3}>
                ...
                <Typography className=" text-[#ffffff80] font-openSans text-[14px] ">
                  Tôi đã đọc và đồng ý với <span className="text-primary opacity-[0.9]">CHÍNH SÁCH</span> của chương
                  trình.
                </Typography>
